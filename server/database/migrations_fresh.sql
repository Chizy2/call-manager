-- Supabase Migration Script for Call Hub (Fresh Install)
-- Run this in your Supabase SQL Editor if you're starting fresh
-- This will drop existing tables - USE WITH CAUTION!

-- Enable UUID extension for auth.users
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Drop existing tables and policies (CAUTION: This deletes all data!)
